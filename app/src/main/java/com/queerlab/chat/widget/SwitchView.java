 ...
 * @Description: 仿ios选择按钮
 * @Author: 鹿鸿祥
 * @CreateDate: 5/19/21 9:44 AM
 * @UpdateUser: 更新者
 * @UpdateDate: 5/19/21 9:44 AM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
//        final int DEFAULT_COLOR_PRIMARY_DARK = 0xFF3AC652;
        final int DEFAULT_COLOR_PRIMARY = 0xFFFFA52C;
        final int DEFAULT_COLOR_PRIMARY_DARK = 0xFFFFA52C;

 ...
 * @Description: 全能输入框(删除/显示隐藏密码/数字分离/禁用表情)
 * @Author: 鹿鸿祥
 * @CreateDate: 5/8/21 1:41 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 5/8/21 1:41 PM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class CustomEditText extends AppCompatEditText {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSeparator = a.getString(R.styleable.CustomEditText_x_separator);
        if (mSeparator == null) {
            mSeparator = "";
        }
        ...
        disableClear = a.getBoolean(R.styleable.CustomEditText_x_disableClear, false);
        if (!disableClear) {
            int cdId = a.getResourceId(R.styleable.CustomEditText_x_clearDrawable, -1);
            if (cdId == -1)
        ...
        boolean togglePwdDrawableEnable = a.getBoolean(R.styleable.CustomEditText_x_togglePwdDrawableEnable, true);
        int inputType = getInputType();
        if (togglePwdDrawableEnable && (inputType == 129 || inputType == 145 || inputType == 18 || inputType == 225)) {
            ...
            mShowPwdResId = a.getResourceId(R.styleable.CustomEditText_x_showPwdDrawable, -1);
            mHidePwdResId = a.getResourceId(R.styleable.CustomEditText_x_hidePwdDrawable, -1);
            if (mShowPwdResId == -1)
        ...
        disableEmoji = a.getBoolean(R.styleable.CustomEditText_x_disableEmoji, false);

        String pattern = a.getString(R.styleable.CustomEditText_x_pattern);
